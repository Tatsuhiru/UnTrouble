...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public ArrayList<com.example.untrouble.ModelData> getAllData() {
        ArrayList<com.example.untrouble.ModelData> arrayList = new ArrayList<>();
        ...
        while (cursor.moveToNext()) {
            ...
            com.example.untrouble.ModelData modelData = new com.example.untrouble.ModelData(id, title, date, time);
